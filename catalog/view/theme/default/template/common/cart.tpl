...
<div class="cart__wrapper">
    <div class="cart bg-light-red">
        ...
        <button class="cart__dropdown__activator__btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <ul class="dropdown-menu pull-left" id="cart__dropdown" style="top: 178px !important;">
