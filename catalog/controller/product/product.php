...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['recently_watched'] = $this->load->controller('product/recently_viewed', $product_info);
            ...
            $data['related_products'] = $this->load->controller('product/products_slider', ['products' =>  $data['products'], 'title' => $this->language->get('text_recommend')]);
			$data['tags'] = array();
