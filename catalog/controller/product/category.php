		...
		if ($category_info || $category_id == 0) {
			...
			foreach ($results as $result) {
				...
				$data['categories'][] = array(
					...
					'href' => $this->url->link('product/category', 'path=' . str_replace('0_', '', $this->request->get['path'] . '_' . $result['category_id']) . $url)
				);
			}
			...
			foreach ($results as $result) {
				...
				$data['products'][] = $this->load->controller('product/product_item', $result);
			}
			...
			$data['page_text'] = $this->language->get('page');
			$data['view_text'] = $this->language->get('view_text');
